...
public class OracleBookDAO implements BookDAO {
	...
	public int insert(Book book){
		...
		String sql = new StringBuilder()
				.append("insert into bookstorage (id, title, author, publisher, instock, price, regdate) ")
	...
	public Book select(int id) {
		...
		String sql = "select * from bookstorage where id=?";
	...
	public int delete(int id) {
		...
		String sql = "delete bookstorage where id=?";
